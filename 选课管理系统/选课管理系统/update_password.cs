    ...
    public partial class update_password : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "select answer,password from student where student_num=" + student_login.number;
                ...
                while (dataReader.Read())
                {
                    ...
                    else
                    {
                        ...
                        dataReader.Close();
                        string sql1 = "update student set password='" + text17.Text +  "' where student_num='" +
